...
def extract_data():
    ...
    for i in range(1,5):
        path = './' + sys.argv[i] + '.txt'
        spider_pos_file_lines = open(path, "r")
        num_of_lines = len(spider_pos_file_lines.readlines())
        for j in range(0,5):
            if (i==1 and j==0):
                    file_path = "./dataset/CTD_TR_neg_SPIDER.csv"
            if (i==1 and j==1):
                    file_path = "./dataset/AAC_TR_neg_SPIDER.csv"
            if (i==1 and j==2):
                    file_path = "./dataset/PAAC_TR_neg_SPIDER.csv"
            if (i==1 and j==3):
                    file_path = "./dataset/DPC_TR_neg_SPIDER.csv"
            if (i==1 and j==4):
                    file_path = "./dataset/APAAC_TR_neg_SPIDER.csv"
            if (i==2 and j==0):
                    file_path = "./dataset/CTD_TR_pos_SPIDER.csv"
            if (i==2 and j==1):
                    file_path = "./dataset/AAC_TR_pos_SPIDER.csv"
            if (i==2 and j==2):
                    file_path = "./dataset/PAAC_TR_pos_SPIDER.csv"
            if (i==2 and j==3):
                    file_path = "./dataset/DPC_TR_pos_SPIDER.csv"
            if (i==2 and j==4):
                    file_path = "./dataset/APAAC_TR_pos_SPIDER.csv"
            if (i==3 and j==0):
                    file_path = "./dataset/CTD_TS_neg_SPIDER.csv"
            if (i==3 and j==1):
                    file_path = "./dataset/AAC_TS_neg_SPIDER.csv"
            if (i==3 and j==2):
                    file_path = "./dataset/PAAC_TS_neg_SPIDER.csv"
            if (i==3 and j==3):
                    file_path = "./dataset/DPC_TS_neg_SPIDER.csv"
            if (i==3 and j==4):
                    file_path = "./dataset/APAAC_TS_neg_SPIDER.csv"
            if (i==4 and j==0):
                    file_path = "./dataset/CTD_TS_pos_SPIDER.csv"
            if (i==4 and j==1):
                    file_path = "./dataset/AAC_TS_pos_SPIDER.csv"
            if (i==4 and j==2):
                    file_path = "./dataset/PAAC_TS_pos_SPIDER.csv"
            if (i==4 and j==3):
                    file_path = "./dataset/DPC_TS_pos_SPIDER.csv"
            if (i==4 and j==4):
                    file_path = "./dataset/APAAC_TS_pos_SPIDER.csv"
            lines= 0      
            while (lines<=(num_of_lines-2)):
                li = [] 
